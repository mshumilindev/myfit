...
export const en = {
  ...
  goalsTab: 'Goals',
  goalsIntro: 'Programs say what you train. Goals say why — the shape you\'re building toward and what this block emphasises.',
  ...
  focusHint: 'Grow adds volume and moves a muscle up in exercise suggestions; ease off trims it back.',
  focusReset: 'Reset',
  ...
  ltHowBody: 'Extra volume, priority in exercise suggestions, and first on the weak-point radar — for these muscles.',
