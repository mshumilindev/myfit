...
export const uk: Strings = {
  ...
  inLibraryVideos: (n: number, v: number) => `${n} у бібліотеці · ${v} з відео-демонстрацією`,
  ...
  flagExerciseFeatureDesc:
    'Медіа-галерея, сторінки вправ з відео та таб «Вправи» на сторінці Programs.',
  ...
  libCoverage: (total: number, rich: number) =>
    `${total} у бібліотеці · ${rich} з інструкціями та фото · кілька з відео`,
  ...
  libHasVideoOnly: 'Лише з відео',
  libCuratedTag: 'курована',
  ...
  sparseExplainer:
    'Поки немає класифікації, інструкцій чи фото для цієї вправи. Ці блоки приховані — вони з’являться автоматично після повного імпорту даних.',
  sparseMusclesNote: 'Основний — з нашого маппінгу · допоміжні для курованих вправ не задані',
  historyDerivedNote:
