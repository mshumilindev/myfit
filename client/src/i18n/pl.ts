...
export const pl: Strings = {
  ...
  inLibraryVideos: (n: number, v: number) => `${n} w bibliotece · ${v} z pokazem wideo`,
  ...
  flagExerciseFeatureDesc:
    'Galeria multimediów, strony ćwiczeń z wideo i zakładka Ćwiczenia w Programach.',
  ...
  libCoverage: (total: number, rich: number) =>
    `${total} w bibliotece · ${rich} z instrukcjami i zdjęciami · kilka z wideo`,
  ...
  libHasVideoOnly: 'Tylko z wideo',
  libCuratedTag: 'wyselekcjonowane',
  ...
  sparseExplainer:
    'Brak jeszcze klasyfikacji, instrukcji i zdjęć dla tego ćwiczenia. Te bloki są ukryte — pojawią się automatycznie po pełnym imporcie danych.',
  sparseMusclesNote:
    'Główny z naszego mapowania · brak pomocniczych dla wyselekcjonowanych ćwiczeń',
  historyDerivedNote:
