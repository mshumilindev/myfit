...
export const lt: Strings = {
  ...
  inLibraryVideos: (n: number, v: number) => `${n} bibliotekoje · ${v} su vaizdo demonstracija`,
  ...
  flagExerciseFeatureDesc:
    'Medijos galerija, pratimų puslapiai su vaizdu ir Pratimų skirtukas Programose.',
  ...
  embeddedAttribution: 'įterpta su nuoroda į šaltinį',
  ...
  libCoverage: (total: number, rich: number) =>
    `${total} bibliotekoje · ${rich} su instrukcijomis ir nuotraukomis · keli su vaizdo įrašu`,
  ...
  libHasVideoOnly: 'Tik su vaizdo įrašu',
  libCuratedTag: 'parinkta',
  ...
  sparseExplainer:
    'Šiam pratimui dar nėra klasifikacijos, instrukcijų ar nuotraukų. Šie blokai paslėpti — jie atsiras automatiškai po pilno duomenų importo.',
  sparseMusclesNote:
    'Pagrindinis iš mūsų atvaizdavimo · pagalbiniai parinktiems pratimams nenustatyti',
  historyDerivedNote:
