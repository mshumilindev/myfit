...
import { aboutSomeoneElse } from './safety';
...
const BODY_PAIN: [string[], string, string][] = [
  ...
  [
    ...
    'Wrist: wrist wraps, the bar low in the palm over the forearm, neutral grips, dumbbells instead of a straight bar. Always wrap your thumb around the bar on presses.',
    'Зап’ястя: бинти, гриф низько в долоні над передпліччям, нейтральний хват, гантелі замість прямого грифа. На жимах великий палець завжди обхоплює гриф.',
  ],
  [
...
export const INTENTS: Intent[] = [
  ...
  },
  {
    ...
    answer: (_c, _p, L) =>
      L(
        'Creatine monohydrate, 3–5 g a day, any time — the one supplement with solid evidence. The rest is mostly marketing. Pre-workouts are mostly caffeine — count them in your daily caffeine. Kidney issues, under 18, pregnant or on regular medication: ask a doctor first.',
        'Креатин моногідрат, 3–5 г на день, будь-коли — єдина добавка з міцними доказами. Решта здебільшого маркетинг. Передтренувальні комплекси — це переважно кофеїн, рахуй його в денну норму. Проблеми з нирками, до 18 років, вагітність чи постійні ліки — спершу до лікаря.',
      ),
  },
  {
    id: 'temper',
